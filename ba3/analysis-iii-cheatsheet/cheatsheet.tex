...
\begin{minipage}[t]{0.24\textwidth}
	\textbf{Dirac Delta}\\
	$\delta(\varphi) = \varphi(0)$ for all $\varphi \in \mathcal{D}.$\\
	$\delta'(\varphi) = -\varphi'(0)$ for all $\varphi \in \mathcal{D}.$
\end{minipage}
\hfill
\begin{minipage}[t]{0.24\textwidth}
...
\begin{minipage}[t]{0.24\textwidth}
	...
	$a \in \mathbb{R},$ $(a\delta)(\varphi) = a \cdot \varphi(0).$ \\
	$(a\delta)'(\varphi) = -a \cdot \varphi'(0).$
\end{minipage}
\hfill
\begin{minipage}[t]{0.24\textwidth}
	\small
	\textbf{Heaviside Step $H'(x) = \delta(x).$}\\
	$H(x) =
		\begin{cases}
			0 & \text{if } x < 0,    \\
			1 & \text{if } x \geq 0.
