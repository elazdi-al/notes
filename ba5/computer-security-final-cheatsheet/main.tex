		      ...
		      \begin{enumerate}[leftmargin=10px]
			      ...
			      \item \textbf{CWE 79 - Cross Site Scripting.} application embeds unvalidated user input into dynamically generated web content, causes browser to execute injected scripts.\\
			            ...
			            \begin{minipage}[t]{0.45\textwidth}
				            ...
				            \textit{Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Mobile Safari/537.36}\\\vfill
				            \texttt{window.location.replace(url)}\\
				            Forces navigation to \texttt{url} without adding a history entry.\\\vfill
			            ...
			            \begin{minipage}[t]{0.45\textwidth}
				            ...
				            Gets/sets legacy origin relaxation; useful because it can broaden trust across subdomains and weaken same-origin isolation.\\\vfill
				            \texttt{document.referrer}\\
				            Returns the referrer URL when sent; useful because it can leak sensitive paths or parameters without a strict Referrer-Policy.\\\vfill
				            \texttt{document.URL}\\
