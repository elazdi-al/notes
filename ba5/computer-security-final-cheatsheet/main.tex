...
\begin{minipage}[htp]{0.5\textwidth}
	\textbf{Testing.} process of executing a program to find errors.
	\textbf{Error.} deviation between observed behavior and specified behavior (a violation of the underlying specification)
\end{minipage}
\begin{minipage}[htp]{0.5\textwidth}
