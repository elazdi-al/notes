...
\begin{minipage}[t]{0.495\textwidth}
	...
	\begin{minipage}[t]{0.65\textwidth}
		...
		\hline
		\textbf{1. Encrypt-and-MAC.} send $E_K(P_1P_2)$ and $MAC_K(P_1P_2)$. protects plaintext only, not ciphertext; inefficient and leaks repetition.\\
		\textbf{2. MAC-then-Encrypt} send $E_K(P_1P_2||MAC_K(P_1P_2))$. hides MAC and provides confidentiality but ciphertext can be altered undetected.\\
