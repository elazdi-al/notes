...
\begin{minipage}[t]{0.495\textwidth}
	...
	\begin{minipage}[t]{0.35\textwidth}
		\textbf{Block Cipher - Counter Mode (CTR)}\\add randomness per-block without inter-block dependencies.\\
	...
	\begin{minipage}[t]{0.65\textwidth}
		...
		\hline
		\textbf{1. Encrypt-and-MAC.} send $E_K(P₁P₂)$ and $MAC_K(P₁P₂)$. protects plaintext only, not ciphertext; inefficient and leaks repetition.\\
		\textbf{2. MAC-then-Encrypt} send $E_K(P₁P₂||MAC_K(P₁P₂))$. hides MAC and provides confidentiality but ciphertext can be altered undetected.\\
		\textbf{3. Encrypt-then-MAC} send $E_K(P₁P₂||MAC_K(E_K(P₁P₂))$. \textbf{authenticates} ciphertext, ensures \textbf{confidentiality/integrity} \checkmark
	\end{minipage}
\end{minipage}
\end{document}
